...
class SQIL(nn.Module):
    ...
    def compute_distances(self, value_a, value_b, reconstructed_features_a, reconstructed_features_b):
    ...
    def forward(self, features_a, features_b):
        ...
        distances = self.compute_distances(value_a, value_b, reconstructed_features_a, reconstructed_features_b)
